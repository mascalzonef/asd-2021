package it.unical.inf.asd.app4;

import it.unical.inf.asd.app3.Application3;
import it.unical.inf.asd.app4.bean.DemoManager;
import it.unical.inf.asd.app4.config.ApplicationConfiguration;
...
@ComponentScan(basePackages = "it.unical.inf.asd")
